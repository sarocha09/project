					...
					<form action="{{ url('admin/user/store') }}" method="post" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-md-3">
								...
								<input type="text" class="form-control form-control-sm" name="txtUsername" value="">
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-3">
								...
								<input type="password" class="form-control form-control-sm" name="txtPassword" value="">
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-3">
								<label>Phone</label>
								<input type="text" class="form-control form-control-sm" name="txtPhone" value="">
							</div>
						</div>
